...
Stopp! Es gab doch schon Mal einen Beitrag, der genauso ähnlich klingt, oder? Ja, du hast vollkommen Recht. In einem (nicht mehr aktiven) Beitrag vor einiger Zeit habe ich erklärt wie man Grunt für optimierte Frontend-Entwicklung verwenden kann. Wenn du diesen bereits kennst, dann wird dir der folgende Artikel sehr leicht fallen, wenn nicht, dann aber auch, da ich wie im anderen Artikel auch Schritt für Schritt in Gulp einsteigen werde.
