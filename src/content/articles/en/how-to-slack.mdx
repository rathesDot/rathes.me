...
When working in distributed companies and teams it is even more important that you communicate more often and more efficiently. And it is not always an easy task but there are plenty of tools to support you. One of them is Slack who have changed the way we work a lot — even in co-located teams.
...
As mentioned above, it is really important that you communicate often. It is better that you post in Slack too much than too less.
...
So make sure that you separate the information that has a long-term value from your day-to-day communication. Make sure that everything that you might need later is organized in a knowledge base. Tools like [Notion](https://www.notion.so/) or [Slite](https://slite.com/) might help you with that (or even confluence if you like to do it the painful way).
...
If someone is not responding you immediately, it does not mean that they are ignoring you. They might be busy with another task, be in a meeting or just went to the kitchen to grab a coffee. So be patient and wait until they are back.

### Don't @channel/@here just because you can

It is tempting to push a notification to everybody just to make sure that everybody you want to reach are getting the notification. But most of the time you will send a notification more to people that are actually not interested.

### Respect the channel's purpose

If you have an exciting news to share, you might be triggered to share that in a channel that is actually dedicated for something else because you know that the people you want to reach are in there. This will to a long train of messages that do not belong in the channel and people actually working in there will have a hard time finding the things they need.
...
When someone posts something in a team channel and everybody starts responding to it you will definitely miss the question that someone else has asked in the same channel. To keep those conversations organized keep the chat about one topic in threads. Slack has the wonderful feature to share messages from the thread also into the channel if you think that the message might be interesting for others as well.

### Answer with emojis

Instead posting "I agree" or "Done" all the time, use an appropriate emoji for that. That will save you a lot of mess.

### Respect time zones and DNDs

In distributed teams, it is pretty likely that your team member will in another time zone that you are. Make sure that you keep that in mind when you send a message to people and trigger a notification. 10am at your place can be in the middle of the night for someone else.
...
Working in a distributed teams also means that you won't see your colleagues that often. In teams spread over multiple time zones even less. That makes it important that you help your colleagues to remember you. If possible try to keep the video on when having calls. And even more important make sure that you have set up a profile picture. Nothing feels more awkward than chatting to someone not remembering who they are. Or meeting your colleague that you work with super closely at a team event and not recognizing them.

## Organized communication

In addition to introducing an etiquette, it is also important that you organize the Slack workspace in way that your employees can communicate in a structured way.
...
Even in a remote company working should be fun. In the office, you will have those silly conversation and all the fun. You should have them in a distributed team as well. Have channels (yes more than one) for all these random things.
...
You see there are a some things to consider when you set up Slack. But all of them are worth it. The earlier you work on to get the Slack workspace organized the easier it will be and the more productive your company will be.
...
[Slack keyboard shortcuts](https://slack.com/intl/en-gb/help/articles/201374536-Slack-keyboard-shortcuts)

### Slash commands

Slack comes with the handy feature called slash commands. Just start typing a slash (`/`) and a few commands will pop up.

My favorite one is the `/remind` command that you can use to set reminders within Slack.

Example: `/remind me to write the blog post tomorrow morning at 10 am`

[Use built-in slash commands](https://slack.com/intl/en-gb/help/articles/201259356-Use-built-in-slash-commands)

### Type in your own inbox

Slack does not only let you DM your colleagues, they also offer a inbox to send messages to yourself. Use that inbox to write down notes, prepare messages before posting them into the channels or (what I like to do) share links between devices.
...
My favorite one is the Google Calendar integration. It does not only shows the meetings and reminds me early enough. It also set my status to "In meeting" automatically and even shows me the hangouts like to join.
...
That is why it is important that you have a organized workspace that even when your team grows, communication will never become an issue.
