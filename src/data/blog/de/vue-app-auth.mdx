...
<Note>
  ...
  dann melde dich gerne auf [Bluesky](https://bsky.app/profile/rathes.me)
</Note>
...
Diese Information ist in der Regel ein Token, das von der API geliefert bei Login wird. Du kannst dafür zum Beispiel das [JSON Webtoken](/de/blog/json-web-token) verwenden. Dieses Token musst du also immer mitschicken. Wie dieses Token erzeugt wird, ist aber nicht die Aufgabe der Webapp. Das ist der Job der API.
