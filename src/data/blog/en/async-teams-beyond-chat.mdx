...
One day, I want to create a new team again and work on projects like [Maxout](/blog/en/introducing-maxout). And if I do, this is the kind of tool I'd want to use before the first thread ever got started.
