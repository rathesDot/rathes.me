...
Recently, I put my first product up for sale on my website. I created a minimal portfolio design for my blog a while ago, which I did not use. So, why not prepare that as a Figma template that I can put up for sale? This is how [Calais](https://aheenam.com/templates/calais) was born.
...
My immediate thought was to use either [Stripe](https://stripe.com) or [Lemon Squeezy](https://www.lemonsqueezy.com). Stripe was the more obvious for me as I've used Stripe quite often in my career. From simple donation pages to entire SaaS applications with discounts and grandfathered pricing, I've already seen most of what Stripe can offer.
...
The first thing I did before even creating an account at Lemon Squeezy was to set up the pages on my website. The idea was to have a custom page for the product and then use the [Hosted Checkout](https://docs.lemonsqueezy.com/help/checkout/hosted-checkout) option from Lemon Squeezy. With that option, you get a “share link” to a checkout page for the product created and hosted by the payment provider. So, all I would then have to do was use that link on my website when the visitors clicked the “Buy” button.
