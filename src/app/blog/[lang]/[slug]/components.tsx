...
const orderedList = cva({
  base: "list-decimal pl-6 my-4 space-y-4 marker:text-neutral-400",
})
const unorderedList = cva({
  base: "list-disc pl-6 my-4 space-y-4 marker:text-neutral-400",
})
const listItem = cva({ base: "antialiased [&_p]:mb-0" })
...
const quote = cva({
  base: "relative my-8 py-8 pl-12 pr-8 bg-neutral-50 text-neutral-500 outline outline-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:outline-neutral-800 rounded-sm",
})
...
const codeBlock = cva({
  base: "my-8 overflow-x-auto rounded-sm bg-neutral-50 p-8 text-neutral-500 outline outline-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:outline-neutral-800",
})

const note = cva({
  base: "my-8 p-8 bg-neutral-50 text-neutral-500 outline outline-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:outline-neutral-800 rounded-sm",
  variants: {
    fontFamily: {
      mono: "font-mono",
    },
