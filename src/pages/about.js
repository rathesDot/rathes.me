...
const SecondPage = ({ data }) => (
  <Layout className="p-4">
    ...
    <p>
      I started working as a web designer and web developer at very young ages.
      At the age of 14, I earned my first money as a web designer creating
      custom MySpace layouts and in 2008, at the age of 16, I founded my first
      own company for web design and development. Since then I have worked with
    ...
    <p>
      ...
      Python or Node.js but also as a front-end developer working with HTML/CSS
      and JavaScript.
    </p>
    <p>
      However, my real passion is not for software and development. I’m more
      into solving problems for people, make their lives easier and connect them
      with each other. Together with that, I’m passionate about learning new
    ...
    <p>
      Apart from that, I spent most of my time working smaller side projects at
