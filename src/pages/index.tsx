...
const IndexPage: React.FC<React.PropsWithChildren<NextPage>> = () => (
  <PageLayout>
    <Meta title="Home" />
    <section>
      <h1 className="mb-8 max-w-[640px] break-words font-sansDisplay text-xl font-semibold leading-snug text-neutral-900 antialiased dark:text-neutral-50 sm:text-2xl">
      ...
      <p className="mb-8 max-w-[640px] break-words font-sansDisplay text-xl font-semibold leading-snug text-neutral-900 antialiased dark:text-neutral-50 sm:text-2xl">
